...
(function (ConfigCategory) {
    ...
    ConfigCategory["WORDPRESS"] = "wordpress";
    ConfigCategory["REDIS"] = "redis";
    ConfigCategory["DATABASE"] = "database";
    ConfigCategory["SECURITY"] = "security";
    ConfigCategory["PERFORMANCE"] = "performance";
    ConfigCategory["FEATURES"] = "features"; // Feature flags and optional configs (loaded on demand)
...
class ConfigCache {
     ...
     */
    generateValidationHash(category) {
