...
class SyncService {
     ...
     */
    async syncProductsFromWooCommerce(options = {}) {
        const startTime = Date.now();
        const { batchSize = 50, force = false, dryRun = false } = options;
        this.isRunning = true;
     ...
     */
    async syncOrdersFromWooCommerce(options = {}) {
        const startTime = Date.now();
        const { batchSize = 50, force = false, dryRun = false } = options;
        this.isRunning = true;
        this.currentProgress = {
     ...
     */
    async getWooCommerceProductCount() {
        try {
     ...
     */
    async getWooCommerceOrderCount() {
        try {
