...
export class TransformationService {
   ...
   */
  static transformCategory(wooCategory: any): any {
    return {
   ...
   */
  static transformOrder(wooOrder: any): any {
    return {
   ...
   */
  static transformCustomer(wooCustomer: any): any {
    return {
   ...
   */
  static createWebhookEvent(eventType: string, resourceType: string, resourceId: number, payload: any): any {
    return {
